function [clickInd,ppSignal,durClick,dur95usec,bw3db,bw10db,yNFilt,yFilt,specClickTf,...
...
% buffVal = hdr.fs*.00025; % Add small buffer, here, I want 250 us, so computing how many samples to use.
